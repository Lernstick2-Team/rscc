...
public class CommandHandler {
    ...
    private void initializeCommands() {
        vncViewer = new Command("vncviewer");
        vncViewerListen = new Command("-listen");
        vncViewerCompression = new Command("-compresslevel", "-CompressLevel", "-CompressionLevel", null);
        vncViewerQuality = new Command("-quality", "-QualityLevel", "-QualityLevel", null);
        vncViewerBgr233 = new Command("-bgr233", "-LowColorLevel", "-LowColorLevel", null);
    ...
    private static class Command {
        ...
        public Command(String commandDebian, String commandArchlinux, String commandMacOs, String commandWindows) {
